...
import com.nfebrief.aleetino.utility.ImageCaptureHelper;
...
public class AdvancedWebView extends WebView {
	...
	protected ImageCaptureHelper mImageCaptureHelper = new ImageCaptureHelper();
...
//			}
	...
	protected void openFileInput(final ValueCallback<Uri> fileUploadCallbackFirst, final ValueCallback<Uri[]> fileUploadCallbackSecond, final boolean allowMultiple) {
		...
		// add camera to chooser
		Intent chooserIntent = Intent.createChooser(i, getFileUploadPromptLabel());
		mImageCaptureHelper.setupChooserIntent(chooserIntent);
