package com.nfebrief.aleetino.view;
...
public class StatefulLayout extends FrameLayout
{
	...
	public StatefulLayout(Context context, AttributeSet attrs, int defStyleAttr)
	{
		...
		TypedArray typedArray = context.obtainStyledAttributes(attrs, com.nfebrief.aleetino.R.styleable.StatefulLayout);
		if(typedArray.hasValue(com.nfebrief.aleetino.R.styleable.StatefulLayout_state))
		{
			int initialStateValue = typedArray.getInt(com.nfebrief.aleetino.R.styleable.StatefulLayout_state, State.CONTENT.getValue());
			mInitialState = State.valueToState(initialStateValue);
		}
		if(typedArray.hasValue(com.nfebrief.aleetino.R.styleable.StatefulLayout_progressLayout) &&
				typedArray.hasValue(com.nfebrief.aleetino.R.styleable.StatefulLayout_offlineLayout) &&
				typedArray.hasValue(com.nfebrief.aleetino.R.styleable.StatefulLayout_emptyLayout))
		{
			mProgressLayoutId = typedArray.getResourceId(com.nfebrief.aleetino.R.styleable.StatefulLayout_progressLayout, 0);
			mOfflineLayoutId = typedArray.getResourceId(com.nfebrief.aleetino.R.styleable.StatefulLayout_offlineLayout, 0);
			mEmptyLayoutId = typedArray.getResourceId(com.nfebrief.aleetino.R.styleable.StatefulLayout_emptyLayout, 0);
		}
		else
		{
